...
//           backgroundColor: buttonItem.isSelected ? Colors.blue[500] : Colors.blue[50],
//         ),
//         child: Center(
//           child: Text(
//             buttonItem.label,
...
//   void initState() {
//     super.initState();
//     // Initialize buttons with custom labels (change as needed)
//     buttonItems = [
//       ButtonItem(label: ''),
//       ButtonItem(label: 'Button 2'),
//       ButtonItem(label: 'Button 3'),
//       ButtonItem(label: 'Button 4'),
//     ];
//   }
